...
FILE="$HOME/.config/polybar/mybar/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/mybar/scripts/rofi/launcher.rasi
